...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar data-options="scrolltop: false">
    <ul class="title-area">
      <li class="name">
        <h1 class="hide-for-large-up"><a href="http://localhost:4000" class="icon-tree site-title"> Konstantin Nomerotski - Portfolio</a>
        </h1>
      </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
        ...
        <li><a 
            href="http://localhost:4000/" >Home</a></li>
          <li class="divider"></li>
          ...
          <li class="has-dropdown">
            ...
            <ul class="dropdown">
              ...
              <li><a 
                  href="http://localhost:4000/info/" >About</a></li>
              

              

              <li><a 
                  href="http://localhost:4000/cv/" >CV</a></li>
          ...
          <li class="has-dropdown">
            ...
            <ul class="dropdown">
              ...
              <li><a 
                  href="http://localhost:4000/portfolio/ligand-x/" >Ligand-X</a></li>
              

              

              <li><a 
                  href="http://localhost:4000/portfolio/rep-sampling-for-nea/" >Rep. Sampling for NEA</a></li>
              

              

              <li><a 
                  href="http://localhost:4000/portfolio/biscuit-dunking-analysis/" >Biscuit Dunking Analysis</a></li>
              

              

              <li><a 
                  href="http://localhost:4000/portfolio/cloud-paradigm-atlas-data-processing/" >Cloud paradigm ATLAS data processing</a></li>
              

              

              <li><a 
                  href="http://localhost:4000/portfolio/atmospec-data-visualization-module/" >Atmospec Data Visualization module</a></li>
              

              

              <li><a 
                  href="http://localhost:4000/portfolio/this-website/" >This Website</a></li>
              

              

              <li><a 
                  href="http://localhost:4000/portfolio/accelerating-python-code/" >Python code acceleration</a></li>
          ...
          <li class="has-dropdown">
            ...
            <ul class="dropdown">
              ...
              <li><a 
                  href="http://localhost:4000/blog/" >Recent</a></li>
              

              

              <li><a 
                  href="http://localhost:4000/blog/archive/" >Blog Archive</a></li>
          ...
          <li class="has-dropdown">
            ...
            <ul class="dropdown">
              ...
              <li><a 
                  href="http://localhost:4000/guides/" >Topics</a></li>
      ...
      <ul class="right">
        ...
        <li class="divider"></li>
        <li><a 
            href="http://localhost:4000/search/" >Search</a></li>
        ...
        <li class="divider"></li>
        <li><a 
            href="http://localhost:4000/contact/" >Contact</a></li>
