...
const API_GROUPS = [
  ...
  },
  {
    id: 'jobs',
    title: 'Jobs',
    desc: 'The unified job queue. Long-running computations (docking, MD, Boltz-2, QC, ABFE, RBFE, REINVENT, kinetics) are submitted here and executed by Celery workers. Pro job types require a valid license.',
  },
  {
    id: 'websocket',
    title: 'WebSocket',
    ...
    <table className="port-table">
      ...
      <tbody>
        {[
          ...
          ['/api/kinetics/*',  'Kinetics',       '8014', 'Pro · WESTPA / RAMD unbinding kinetics'],
