    ...
    <div className="container-wide topnav-inner">
      ...
      <div className="nav-right">
        ...
        <button
          ...
          onClick={() => window.open('https://github.com/kon-218/ligand-x', '_blank')}
        >
      ...
      <div className="foot-inner">
        <div>
          ...
          <p style={{ color: 'var(--muted)', fontSize: 13.5, maxWidth: 320, margin: 0 }}>
            An open, self-hosted computational chemistry platform for the full drug-discovery
        ...
        <div>
          <h6>Project</h6>
          <ul>
            <li><a href="https://github.com/kon-218/ligand-x" target="_blank">GitHub</a></li>
            <li><a>Issues</a></li>
