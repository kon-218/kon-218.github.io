...
const OS_OPTIONS = [
  {
    ...
    archs: [
      { arch: "x86_64", file: "ligandx-launcher-windows-amd64-installer.exe", url: "https://github.com/kon-218/ligand-x/releases/latest/download/ligandx-launcher-windows-amd64-installer.exe" },
    ],
    notes: [
  ...
  },
  {
    ...
    sub: "Docker Desktop",
    archs: [
      { arch: "Apple Silicon", file: "ligandx-launcher-darwin-arm64.dmg", url: "https://github.com/kon-218/ligand-x/releases/latest/download/ligandx-launcher-darwin-arm64.dmg" },
      { arch: "Intel", file: "ligandx-launcher-darwin-amd64.dmg", url: "https://github.com/kon-218/ligand-x/releases/latest/download/ligandx-launcher-darwin-amd64.dmg" },
    ],
    notes: [
  ...
  },
  {
    ...
    archs: [
      { arch: "x86_64", file: "ligandx-launcher-linux-amd64.AppImage", url: "https://github.com/kon-218/ligand-x/releases/latest/download/ligandx-launcher-linux-amd64.AppImage" },
    ],
    notes: [
...
./ligandx-launcher-linux-amd64.AppImage`,
  },
  {
    ...
    code: `git clone https://github.com/kon-218/ligand-x.git
cd ligand-x
...
make prod`,
  },
  {
    ...
    desc: "Mounts source into containers and starts the Next.js frontend with hot reload.",
    code: `git clone https://github.com/kon-218/ligand-x.git
cd ligand-x
make dev`,
  },
...
const MODULES = [
  ...
  { group: "Pro images", items: ["licensing", "admet", "qc", "boltz2", "reinvent", "kinetics", "abfe", "rbfe"] },
  { group: "Pro workers", items: ["worker-qc", "worker-gpu-long", "worker-reinvent", "worker-kinetics"] },
];
        ...
        <div className="container">
          ...
          <div style={{ marginTop: 24, background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: 'var(--sp-5) var(--sp-6)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12, marginBottom: 16 }}>
              ...
              <button className="btn btn-primary btn-sm" onClick={() => window.open('https://github.com/kon-218/ligand-x/releases', '_blank')}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {active.archs.map((a) => (
                <div key={a.file} style={{ display: 'grid', gridTemplateColumns: '150px 1fr auto', gap: 16, alignItems: 'center', padding: '12px 16px', background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 'var(--radius)' }}>
                  ...
                  <span className="dl-link" onClick={() => window.open(a.url, '_blank')} style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
        ...
        <div className="container">
          <div className="section-head">
            <div>
              ...
              <h2>Launcher, production CLI, or development mode.</h2>
            </div>
            <p className="sub">
              Use the launcher for desktop installs. Use the CLI for servers, automation, and contributors.
            </p>
          </div>
          <InstallPathCarousel />
        </div>
      ...
      <section className="section">
        <div className="container">
          <div className="section-head">
            ...
            <a href="https://github.com/kon-218/ligand-x/blob/main/CHANGELOG.md" target="_blank" style={{ fontFamily: 'var(--font-mono)', fontSize: 13, color: 'var(--accent-strong)', display: 'inline-flex', alignItems: 'center', gap: 6 }}>
