...
const PRO_MODULES = [
  ...
  {
    title: "Mechanistic insight: Binding Kinetics",
    icon: "wave",
    desc: "Advanced kinetics workflows for pathway, residence-time, and simulation-derived binding analysis.",
    tags: ["RAMD", "WESTPA", "NAMD"],
  },
];
...
const DECISION_MAP_ROWS = [
  ...
  {
    gate: "Mechanistic differentiation: why does binding behavior diverge?",
    baseline: "Long MD campaigns and custom scripts with uneven reproducibility across projects.",
    proWorkflow: "Binding Kinetics + MD-linked analysis",
    output: "Pathway and residence-time evidence package for mechanism-level interpretation.",
    impact: "Retires mechanism ambiguity in borderline decisions and supports cross-team alignment.",
  },
];
...
const PRO_EDITIONS = [
  {
    ...
    items: ["No license file", "Local Docker deployment", "Community source access"],
  },
  {
    name: "Academic",
    badge: "Licensed",
